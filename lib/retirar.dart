...
class Retirar extends StatefulWidget {
  @override
  State<Retirar> createState() => _RetirarState();
}
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text("Quantia retirada: R\$ $quantia"),
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Retirar', style: TextStyle(fontSize: 30.0, color: Colors.white)),
                    ],
                  ),
                ),
              ),
